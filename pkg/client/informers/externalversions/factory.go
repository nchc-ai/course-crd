...
type SharedInformerFactory interface {
	...
	Nchc() coursecontroller.Interface
}

func (f *sharedInformerFactory) Nchc() coursecontroller.Interface {
	return coursecontroller.New(f, f.namespace, f.tweakListOptions)
}
